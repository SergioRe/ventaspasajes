...
<head>
    ...
    <script src="<?php echo base_url('assets/js/funciones/auditoria.js')?>"></script>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="thumbnail">
                    <div class="well">
                        <center><b><p>AUDITORIA</p></b></center>
                    </div>
                    <b>Ejemplo de consultas:</b><br/>
                    select * from nomtabla;
                    <textarea id="sentenciasql" name="sentenciasql" rows="10" class="form-control" cols="50"></textarea></br>
                    <button type="button" class="btn btn-success btn-sm" id="btn-create" onclick="consultar();">
                        <span class="glyphicon glyphicon-ok"></span> <b>Consultar</b> 
                    </button><br/><br/>
                    <div class="well">
